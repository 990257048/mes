        ...
        if (selRows.length > 0) {
            layer.open({
                ...
                yes: function (index) {
                    ...
                    for (var i = 0; i < len; i++){
                        console.log(selRows[i].LABELNAME, selRows[i].R_FILE_NAME);
                        parent.client.CallFunction("MESStation.FileUpdate.Fileuplaod", "DeleteUploadLabelFile", { LabelName: selRows[i].LABELNAME, FileName: selRows[i].R_FILE_NAME }, function (e) {
                            if (e.Status == "Pass") {
                                successCount++;
                                if(successCount == len){
                                    layer.msg("Success", {
                    ...
                    //    Names.push(selRows[i].LABELNAME);  ////LISTNAME    LabelName -- LABELNAME    FileName -- R_FILE_NAME
                    //}
                    //parent.client.CallFunction("MESStation.KeyPart.KPScan", "RemoveKPList", { ListNames: Names }, function (e) {  //接口错的
                    //    if (e.Status == "Pass") {
                    //        layer.msg("Success", {
                    //            icon: 1,
                    //            time: 3000
