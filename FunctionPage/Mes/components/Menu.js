...
class Li extends React.Component {
    ...
    render() {
        var { data, editMenu, addModule, editModule, collection, deleteModule } = this.props;
        ...
        if (contain) {    // 正常的模块
            return <span className="module" style={moduleStyle} onClick={ev => { this.module_click.call(this, ev, contain, link, id) }}>
                ...
                <span className="module-collection glyphicon glyphicon-heart" 
                    style={ {display: collection ? "inline-block" : "none"} } 
                    onClick={() => { console.log(id, contain) }}
                ></span>
